...
simulation = d3.forceSimulation()
  ...
  const dataset =  {
    nodes: [
          ...
          {id: 9, name: 'Estado Inte', label: 'MOSL', group: 'Planeacion', runtime: 0},
          {id: 10, name: 'ANLA', label: 'MOSL', group: 'Planeacion', runtime: 0},
          {id:11, name: 'Transporte', label: 'MOSL', group: 'Infraestructura', runtime: 80},
          {id: 12, name: 'Puntos atencion', label: 'MOSL', group: 'Ent territorial', runtime: 80},
          {id: 13, name: 'Div Politica', label: 'MOSL', group: 'Ent territorial', runtime: 80},
          {id: 14, name: 'Abiotico', label: 'MOSL', group: 'Abiotico', runtime: 80},
          {id: 15, name: 'Abiotico', label: 'MOSL', group: 'Abiotico', runtime: 80},
          {id: 16, name: 'Abiotico', label: 'MOSL', group: 'Abiotico', runtime: 80},
          {id: 17, name: 'Abiotico', label: 'MOSL', group: 'Abiotico', runtime: 80},
